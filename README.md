...
| Андрей Сидоркин   | Создание репозитория, каркас проекта, интерфейс DAO, сервис |
| Илья Ставбур      | Реализация консоль сервис, настройка docker-compose.        |
